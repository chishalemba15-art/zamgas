...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      {/* Footer */}
      <footer className="py-16" style={{ background: zamgasTheme.colors.premium.burgundyDark }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Contact Section */}
          <div className="text-center mb-12">
            ...
            <p className="text-sm mb-8" style={{ color: zamgasTheme.colors.premium.gray }}>
              Ready to order? Call or WhatsApp us now!
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-4xl mx-auto mb-8">
              {/* Primary Contact */}
              <a 
                href="tel:+260773962307"
                className="p-5 rounded-2xl transition-all duration-300 hover:scale-105 active:scale-95 group"
                style={{
                  background: `linear-gradient(135deg, ${zamgasTheme.colors.premium.red} 0%, ${zamgasTheme.colors.premium.redDark} 100%)`,
                  boxShadow: `0 4px 20px ${zamgasTheme.colors.premium.red}40`,
                }}
              >
                <Phone className="h-8 w-8 mx-auto mb-3 text-white group-hover:animate-pulse" />
                <p className="text-white font-bold text-lg mb-1">+260 773 962 307</p>
                <p className="text-white/80 text-xs">Primary Line</p>
              </a>
              
              {/* Second Contact */}
              <a 
                href="tel:+260750216961"
                className="p-5 rounded-2xl transition-all duration-300 hover:scale-105 active:scale-95 group"
                style={{
                  background: zamgasTheme.colors.premium.burgundy,
                  border: `2px solid ${zamgasTheme.colors.premium.gold}50`,
                }}
              >
                <Phone className="h-8 w-8 mx-auto mb-3 group-hover:animate-pulse" style={{ color: zamgasTheme.colors.premium.gold }} />
                <p className="font-bold text-lg mb-1" style={{ color: zamgasTheme.colors.premium.gold }}>+260 750 216 961</p>
                <p className="text-xs" style={{ color: zamgasTheme.colors.premium.gray }}>Customer Support</p>
              </a>
              
              {/* Third Contact */}
              <a 
                href="tel:+260974582961"
                className="p-5 rounded-2xl transition-all duration-300 hover:scale-105 active:scale-95 group"
                style={{
                  background: zamgasTheme.colors.premium.burgundy,
                  border: `2px solid ${zamgasTheme.colors.premium.gold}50`,
              ...
              >
                <Phone className="h-8 w-8 mx-auto mb-3 group-hover:animate-pulse" style={{ color: zamgasTheme.colors.premium.gold }} />
                <p className="font-bold text-lg mb-1" style={{ color: zamgasTheme.colors.premium.gold }}>+260 974 582 961</p>
                <p className="text-xs" style={{ color: zamgasTheme.colors.premium.gray }}>Contracts & Bulk Orders</p>
              </a>
            </div>
            
            {/* WhatsApp Button */}
            <a
              href="https://wa.me/260773962307?text=Hi%20ZAMGAS%2C%20I%20would%20like%20to%20order%20LPG%20gas"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 hover:scale-105 active:scale-95"
              style={{
                background: '#25D366',
                color: 'white',
          ...
          <div 
            className="h-px mb-8" 
            style={{ background: `linear-gradient(90deg, transparent, ${zamgasTheme.colors.premium.gold}30, transparent)` }}
          />
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-4 text-sm" style={{ color: zamgasTheme.colors.premium.gray }}>
